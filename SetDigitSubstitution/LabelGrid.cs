...
namespace UAM.InformatiX.Windows.Controls
{
    public class LabelGrid : Panel
    {
        ...
        public static readonly DependencyProperty VerticalSpacingProperty = DependencyProperty.Register(nameof(VerticalSpacing), typeof(double), typeof(LabelGrid), new PropertyMetadata(5.0));
        public static readonly DependencyProperty HorizontalSpacingProperty = DependencyProperty.Register(nameof(HorizontalSpacing), typeof(double), typeof(LabelGrid), new PropertyMetadata(5.0));
